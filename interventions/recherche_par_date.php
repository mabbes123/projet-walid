...
<?
$date1=$_POST['date1'];
// $date1 est une valeur récupérée au format DD/MM/YYYY
list($d,$m,$y) = explode('/', $date1);
$date_1=$y.'-'.$m.'-'.$d; // date au format anglais

$date2=$_POST['date2'];
// $date2 est une valeur récupérée au format DD/MM/YYYY
...
<p align="center" class="style2"><font size="4"><strong>- Recherche d'intervention(s) réalisée(s) entre le <?=$date1?> et le <?=$date2?> -</strong></font></p>
...
<TABLE border="1" align="center" class="tableau">
    <tr>
	  ...
	  <th width="140" align="center" class="style3" >Type de matériel</th>
