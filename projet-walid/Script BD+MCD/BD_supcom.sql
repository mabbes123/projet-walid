...
-- 
-- Serveur: localhost
-- Généré le : Jeudi 11 Mai 2006 à 17:00
...
INSERT INTO `batiment_etage` (`id_batiment_etage`, `libelle_batiment_etage`) VALUES (1, 'Bat A - Rez de chaussé');
...
INSERT INTO `composant` (`id_composant`, `libelle_composant`, `id_societe`, `id_type_composant`) VALUES (2, 'Pentium 4', 2, 1);
...
INSERT INTO `fonction_utilisateur` (`id_fonction_utilisateur`, `libelle_fonction_utilisateur`) VALUES (1, 'Stagiaire'),
(2, 'Automaticien'),
...
INSERT INTO `intervenant` (`id_intervenant`, `nom_intervenant`, `prenom_intervenant`, `nom_complet_intervenant`, `tel_intervenant`, `portable_intervenant`, `fax_intervenant`, `email_intervenant`, `observation_intervenant`, `id_type_intervenant`, `id_societe`) VALUES (1, 'viriet', 'maxime', 'viriet maxime', '', '', '', '', '', 1, 6);
...
INSERT INTO `logiciel` (`id_logiciel`, `nom_logiciel`, `version_logiciel`, `date_achat_logiciel`, `observation_logiciel`, `id_societe`, `id_service_pack`) VALUES (1, 'Nero', '7', '2007-11-05', 'très bien', 3, 1);
...
CREATE TABLE IF NOT EXISTS `materiel` (
  ...
  `tag_supcom_materiel` varchar(6) NOT NULL default '',
...
INSERT INTO `materiel` (`id_materiel`, `num_serie_materiel`, `tag_supcom_materiel`, `nom_materiel`, `date_achat_materiel`, `adresseip_materiel`, `observation_materiel`, `id_modele_materiel`, `id_type_materiel`, `id_utilisateur`, `id_societe`, `id_statut`) VALUES (4, 'pc666', 'PC666', 'pc666', '0000-00-00', '', '', 1, 1, 1, 6, 3),
(5, 'pc444', 'pc444', 'pc444', '0000-00-00', '', '', 1, 1, 1, 6, 3),
(6, 'grrg', 'grrgrg', 'grrg', '0000-00-00', '', '', 1, 5, NULL, 3, 3),
(7, 'grg', 'grgr', 'grg', '0000-00-00', '', '', 1, 5, NULL, 3, 3);
...
INSERT INTO `modele_materiel` (`id_modele_materiel`, `libelle_modele_materiel`) VALUES (1, 'Optiplex GX270');
...
INSERT INTO `service` (`id_service`, `libelle_service`) VALUES (2, 'Atelier'),
(3, 'Bureau Etude'),
...
INSERT INTO `societe` (`id_societe`, `nom_societe`, `adresse_societe`, `ville_societe`, `cp_societe`, `site_web_societe`, `tel_societe`, `portable_societe`, `fax_societe`, `email_societe`, `observation_societe`, `id_type_societe`) VALUES (1, 'DELL', '', '', '', '', '', '', '', '', '', 1),
(2, 'Intel', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1),
(3, 'AHEAD', '', '', '', '', '', '', '', '', '', 1),
(7, 'CEFF', '', '', '', '', '', '', '', '', '', 3),
(8, 'jyjytj', '', '', '', '', '', '', '', '', '', NULL);
...
INSERT INTO `statut` (`id_statut`, `libelle_statut`) VALUES (1, 'En service'),
(2, 'En panne'),
(3, 'En stock');
...
INSERT INTO `type_composant` (`id_type_composant`, `libelle_type_composant`) VALUES (1, 'Processeur');
...
INSERT INTO `type_intervenant` (`id_type_intervenant`, `libelle_type_intervenant`) VALUES (1, 'commercial');
...
INSERT INTO `type_materiel` (`id_type_materiel`, `libelle_type_materiel`) VALUES (1, 'Ordinateur'),
(2, 'Portable'),
(3, 'Serveur'),
(4, 'Imprimante'),
(5, 'Switch');
...
INSERT INTO `type_societe` (`id_type_societe`, `libelle_type_societe`) VALUES (1, 'Assembleur'),
(3, 'Site supcom');
...
CREATE TABLE IF NOT EXISTS `utilisateur` (
  ...
  `id_fonction_utilisateur` int(2) NOT NULL default '0',
...
INSERT INTO `utilisateur` (`id_utilisateur`, `nom_utilisateur`, `prenom_utilisateur`, `nom_complet_utilisateur`, `login_utilisateur`, `tel_bureau_utilisateur`, `portable_utilisateur`, `email_utilisateur`, `mdp_utilisateur`, `observation_utilisateur`, `id_fonction_utilisateur`) VALUES (1, 'admin', 'admin', 'admin admin', 'admin', '', '', '', 'admin', '', 1);
