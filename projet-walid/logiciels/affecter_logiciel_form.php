...
<p align="center" class="style2"><strong>- Affecter un matériel à un utilisateur -</strong></p>
 ...
 <select size="1" name="materiel">
  ...
  <td><?php
			$requete2 = mysql_query("SELECT * FROM logiciel l, service_pack s where l.id_service_pack=s.id_service_pack order by nom_logiciel, version_logiciel");
			?>
			...
			?>
   			<option value="<?php echo $recup2['id_logiciel']; ?>" selected><?php echo $recup2['nom_logiciel']; echo "&nbsp;"; echo $recup2['version_logiciel'] ; echo "&nbsp;";  echo $recup2['libelle_service_pack']; ?>
			</option>
			<?php
    		}
			?>
