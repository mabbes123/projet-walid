 ...
 <tr>
    ...
    <td><select size="1" name="type_materiel" OnChange="Remplir(type_materiel.value)">
  		<?php
 			...
 			$requete1="Select id_type_materiel, libelle_type_materiel from type_materiel where  libelle_type_materiel <> 'Switch' and libelle_type_materiel <> 'Serveur' order by libelle_type_materiel;";
